...
const EventForm: React.FC = () => {
  ...
  return (
    <>
      <button
        className="neu-button hover:bg-green-900 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out focus:outline-none focus:shadow-outline mt-4"
